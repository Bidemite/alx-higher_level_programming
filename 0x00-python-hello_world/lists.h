 ...
 *
 * Return: it return 1 if the list has a cycle, it returned 0 if it doesn't. 
 */
...
root@09f8402d9aa1:~/alx-higher_level_programming/0x00-python-hello_world# cat lists.h
#ifndef LISTS_H
#define LISTS_H
